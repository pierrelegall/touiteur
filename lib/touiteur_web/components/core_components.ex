defmodule TouiteurWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TouiteurWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TouiteurWeb.Gettext, "errors", msg, opts)
    end
  end
