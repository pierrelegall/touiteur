defmodule TouiteurWeb.UserAuthTest do
  use TouiteurWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Touiteur.Accounts
  alias TouiteurWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TouiteurWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TouiteurWeb.Endpoint.subscribe(live_socket_id)
